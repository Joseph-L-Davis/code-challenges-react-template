import { howMuchPencil, listFoods, wordsToCharList } from '../array-methods.js';

it('It should return a list of shortening words', () => {
...
test('break word into individual chars', () => {
